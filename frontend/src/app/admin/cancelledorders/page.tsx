  ...
  return (
    <div className='flex bg-slate-200'>
      ...
      <div className='pl-16 sm:pl-20 w-full min-h-[100vh] overflow-hidden overflow-y-scroll text-slate-700' >
        <h1 className={`${robotoSlab.className} text-4xl sm:text-5xl text-center my-6 text-main-800`}>Cancelled Orders</h1>
        ...
        <div className=" mx-2 sm:mx-4 my-5 border-2 border-main-800 rounded-xl overflow-hidden relative">
          <div className=' bg-main-800 text-white p-2 text-lg'>
            <div>Razorpay Payment Id: pay_MZodLcOhucqF9X</div>
            <div>Razorpay Order Id:  order_MZod1w9BmXPJgp</div>
          </div>
