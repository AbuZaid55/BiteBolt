...
const Card2 = () => {
    return (
        ...
        <div className="absolute top-0 left-0 p-2 text-xl w-full flex items-center justify-between">
            <span className=" cursor-pointer bg-slate-200 rounded-full p-2 hover:scale-125 hover:bg-red-700 hover:text-white text-slate-700 transition-all duration-200 ease-in-out shadow-md">
                < GoTrash/>
            </span>
