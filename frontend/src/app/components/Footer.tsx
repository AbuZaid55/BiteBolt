...
const Footer = () => {
  return (
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-10  md:grid-cols-4 lg:px-20 mx-auto py-7 bg-slate-200'>
    ...
    <div className='flex items-center justify-center border-t bg-slate-200 border-slate-500 py-1 text-xl text-slate-500'>&#169; 2024 <h1 className=' text-main-800 font-bold mx-1'>BiteBolt</h1> <p>All Rights Reserved</p></div></div>
  )
}
