...
const Card1 = () => {
  return (
    ...
    <div className="flex flex-col sm:flex-row items-center justify-between mt-2">
      ...
      <button className=" bg-slate-700 text-white sm:px-8 sm:py-2 rounded-md flex items-center justify-center w-full sm:w-auto mt-2 border-2 border-slate-700  hover:text-slate-700 hover:bg-[#3341551f] transition-all duration-300 ease-in-out py-1"><span className='mr-2'>ADD</span><MdShoppingCart/></button>
    </div>
  </div>
  )
}
